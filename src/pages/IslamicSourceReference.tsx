        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">Islamic Source Reference</h1>
                <p className="text-xs text-slate-400">Find Quran & Hadith Evidence</p>
              </div>
            </div>

            <button
              onClick={deleteConversationHistory}
              className="flex items-center space-x-2 px-4 py-2 bg-slate-800/80 hover:bg-red-600/20 text-slate-400 hover:text-red-400 rounded-lg transition border border-slate-700/50"
          ...
          <div className="space-y-6">
                ...
                >
                  <div className="flex items-start space-x-3">
                    {message.role === 'assistant' && (
                      <div className="w-8 h-8 bg-gradient-to-br from-emerald-500 to-cyan-600 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <div className="flex-1">
                          ...
                          <div className="space-y-2">
                            {message.references.map((ref, idx) => (
                              <div key={idx} className="bg-slate-900/50 p-3 rounded-lg">
                                <p className="text-xs text-slate-300 italic mb-1.5">"{ref.text}"</p>
                      ...
                      <p className={`text-xs mt-3 ${message.role === 'user' ? 'text-emerald-100' : 'text-slate-500'}`}>
            ...
            {loading && (
              <div className="flex justify-start">
                <div className="max-w-[80%] bg-slate-800/50 border border-slate-700/50 rounded-2xl px-6 py-4">
                  <div className="flex items-center space-x-3">
          ...
          <div className="flex items-end space-x-4">
            <div className="flex-1">
              <textarea
                ...
                disabled={loading}
                rows={1}
                className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent resize-none disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-emerald-500 to-cyan-600 hover:from-emerald-400 hover:to-cyan-500 text-white rounded-xl font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2 h-[52px]"
            >
              {loading ? (
                <>
