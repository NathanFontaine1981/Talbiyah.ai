            ...
            {user && (
              <>
                ...
                <button
                  ...
                  className="px-6 py-2 border border-slate-700 rounded-lg hover:bg-slate-800 transition"
                >
                  Sign Out
                </button>
              </>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-cyan-500/10 border border-cyan-500/30 rounded-full mb-6">
              <span className="text-cyan-400 font-semibold text-sm">Step 1 of 3: Choose Your Subject</span>
            </div>
