...
export default function CourseArabic() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Personalized flashcards and quizzes generated from your lessons'
    },
    {
      icon: Star,
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-lg z-50 border-b border-slate-200 shadow-sm">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                <div className="flex items-center space-x-2 px-4 py-2 bg-white rounded-lg border-2 border-slate-200 shadow-sm">
                  ...
                  <span className="text-sm text-slate-700 font-medium">Native Speaking Teachers</span>
                </div>
                <div className="flex items-center space-x-2 px-4 py-2 bg-white rounded-lg border-2 border-slate-200 shadow-sm">
                  <Play className="w-5 h-5 text-blue-600" />
                  <span className="text-sm text-slate-700 font-medium">Interactive Lessons</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-xl text-lg font-bold transition shadow-xl flex items-center justify-center space-x-2"
                >
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600">Comprehensive Arabic education at every level</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="bg-gradient-to-br from-blue-500 to-cyan-600 p-1 rounded-2xl shadow-lg hover:shadow-xl transition">
