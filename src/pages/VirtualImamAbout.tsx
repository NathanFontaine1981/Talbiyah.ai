        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 border border-slate-200">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold text-slate-900 mb-4">
              Virtual Imam AI Assistant
            </h1>
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Your trusted guide for authentic Islamic knowledge, sourced exclusively from the Qur'an and Sunnah
            </p>
          </div>
          ...
          <div className="space-y-12">
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-slate-900 mb-3">
                    Core Principle of Islamic Jurisprudence
                  </h2>
                  <div className="bg-slate-50 rounded-lg p-6 border-l-4 border-emerald-500">
                    <p className="text-slate-700 leading-relaxed mb-4">
                      Our Virtual Imam operates on a fundamental principle of Islamic jurisprudence that guides all responses:
                    </p>
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <div className="bg-blue-50 rounded-lg p-6 border-l-4 border-blue-500">
                    <p className="text-slate-700 leading-relaxed mb-4">
                      The Virtual Imam's answers are exclusively sourced from:
                    </p>
            ...
            <section className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-8 border border-amber-200">
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">
                When to Consult Your Local Imam
              </h2>
              <p className="text-slate-700 leading-relaxed mb-4">
                While the Virtual Imam provides authentic Islamic guidance based on the Qur'an and Sunnah, certain matters require personalized attention from a qualified scholar. The bot will refer you to consult your local, trusted Imam when:
              </p>
              <ul className="space-y-2 text-slate-700">
                <li className="flex items-start gap-3">
                  <span className="text-amber-600 font-bold">•</span>
                  <span>Questions are too complex or nuanced for a general answer</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-amber-600 font-bold">•</span>
                  <span>Personal or tailored guidance is needed (medical ethics, personal finance, family disputes)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-amber-600 font-bold">•</span>
                  <span>The matter requires context-specific fatwa or detailed scholarly analysis</span>
                </li>
              </ul>
            </section>
            ...
            <div className="text-center pt-8">
              ...
              >
                ...
                Start Chatting with Virtual Imam
              </Link>
              <p className="text-slate-500 text-sm mt-4">
                Available 24/7 to answer your questions about Islam
              </p>
            </div>
          </div>
        </div>
