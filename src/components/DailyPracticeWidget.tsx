...
import { Flame, Brain, ChevronRight, Calendar, BookOpen, Sparkles, Settings, Languages } from 'lucide-react';
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
      <div className="p-6">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={() => navigate('/practice/ayah-recall')}
            className="w-full p-4 rounded-xl border-2 border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-100 dark:hover:bg-blue-900/30 flex items-center justify-between transition"
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="font-medium text-blue-900 dark:text-blue-100">Ayah Recall</p>
                <p className="text-sm text-blue-700 dark:text-blue-400">English to Arabic practice</p>
              </div>
            </div>
