...
export default function TeacherRatingDisplay({ teacherId }: TeacherRatingDisplayProps) {
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-slate-700 shadow-xl animate-pulse">
    ...
    <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-slate-700 shadow-xl">
      ...
      {!hasRatings ? (
        <div className="text-center py-12 bg-slate-800/50 rounded-xl border border-slate-700">
          ...
          <p className="text-slate-400 text-sm">No ratings yet - Be the first to book and review!</p>
        </div>
      ) : (
        <>
          {/* Overall Rating Section */}
          <div className="flex items-start gap-6 mb-8 bg-gradient-to-r from-cyan-500/10 to-blue-600/10 rounded-xl p-6 border border-cyan-500/30">
            ...
            <div className="flex-1 space-y-3">
                ...
                <div className="flex items-center gap-3 bg-slate-800/50 rounded-lg p-3 border border-slate-700">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm text-slate-300">Student Satisfaction</span>
              ...
              {summary.total_detailed_ratings > 0 && (
                <div className="flex items-center gap-3 bg-slate-800/50 rounded-lg p-3 border border-slate-700">
                  ...
                  <div>
                    <span className="text-sm text-slate-300">Would Recommend: </span>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={category.label} className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 rounded-xl p-4 border border-cyan-500/30">
              <div className="flex items-center gap-2 mb-2">
                <TrendingUp className="w-5 h-5 text-cyan-400" />
                <span className="text-sm text-slate-300">Rebook Rate</span>
              </div>
              <div className="text-3xl font-bold text-white">
                {summary.rebook_rate}%
              </div>
              <p className="text-xs text-slate-400 mt-1">Students return for more lessons</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-emerald-600/10 rounded-xl p-4 border border-green-500/30">
              ...
              <p className="text-xs text-slate-400 mt-1">Unique students taught</p>
            </div>

            <div className="bg-gradient-to-br from-purple-500/10 to-violet-600/10 rounded-xl p-4 border border-purple-500/30">
              <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-xs text-slate-400 mt-1">Lessons completed successfully</p>
            </div>
          </div>
              ...
              <div className="space-y-4">
                {reviews.slice(0, 3).map((review, index) => (
                  ...
                  >
                    ...
                    <p className="text-slate-300 leading-relaxed">{review.positive_feedback}</p>
                  </div>
                ))}
              </div>
            </div>
