...
export const EXPLORE_CHAPTERS: Omit<Chapter, 'isUnlocked' | 'isCompleted' | 'progress'>[] = [
  {
    id: 1,
    title: 'Open Mind',
    subtitle: 'The full journey from logic to evidence',
    description: 'Start with what we all agree on, reason through it together, then examine 10 scientific signs in the Quran and work out who could have written it.',
    bulletPoints: [
      'Build foundations from shared logic',
      'Examine 10 scientific signs in the Quran',
