...
export const EXPLORE_CHAPTERS: Omit<Chapter, 'isUnlocked' | 'isCompleted' | 'progress'>[] = [
  {
    id: 1,
    title: 'Open Mind',
    subtitle: 'Establish what we know, reason to the Creator',
    description: 'Start with what we all agree on, reason through it together, then examine how the Quran was preserved.',
    bulletPoints: [
  ...
  },
  {
    ...
    description: "Walk through the Quran's own narrative — verify every scientific claim, discover the deeper reality, and deliver your verdict.",
    bulletPoints: [
  ...
  },
  {
    ...
    subtitle: 'One message through history, the prophets, and the invitation',
    description: "Now that you've seen the evidence, discover the full picture — how the Quran speaks, the prophets, and the invitation.",
    bulletPoints: [
